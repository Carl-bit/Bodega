...
public class VistaBodeguero extends javax.swing.JFrame {
    ...
    private void agregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarActionPerformed
        try {
            VistaPaqueteAgregar agregarP = new VistaPaqueteAgregar();
            agregarP.setVisible(true);
        } catch (SQLException ex) {
            Logger.getLogger(VistaBodeguero.class.getName()).log(Level.SEVERE, null, ex);
        }

    }//GEN-LAST:event_agregarActionPerformed

    private void cerrarSesionActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cerrarSesionActionPerformed
        VistaSelecLogin loginB = new VistaSelecLogin();
        loginB.setVisible(true);
        this.dispose();
    }//GEN-LAST:event_cerrarSesionActionPerformed

    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buscarActionPerformed
        VistaBuscarModificarPaquete buscarP;
        try {
            buscarP = new VistaBuscarModificarPaquete();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VistaBodeguero.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new VistaBodeguero().setVisible(true);
            }
        });
    }
